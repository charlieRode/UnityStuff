...
public class UnitSelectionCtrlV2 : MonoBehaviour
{
    ...
    static UnitSelectionCtrlV2 _instance;
    public static UnitSelectionCtrlV2 Instance
    {
    ...
    void SelectUnits()
    {
        ...
        foreach(UnitController unit in GameCtrlV2.Instance.activeUnitsInGame)
        {
